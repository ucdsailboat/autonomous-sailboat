/* Anemometer and GPS Combined Code - Modified 5/17 M. Shi  
...
int sOffset;                     // calculated offset necessary to map servo commands to sail angle (0 to 90 relative to boat nose) 
...
int getSailOffset(int sDesired);               // calibrated angle from desired sail angle, used with getSailServoCommand
...
int getSailOffset(int sDesired){            // used in getSailServoCommand function 
  return sDesired*0.85 + sZero;             // obtained from crive fit of data 
}
